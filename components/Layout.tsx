...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  // Fungsi klik tombol WhatsApp (satu nomor CS aktif)
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans text-slate-800 dark:text-text-dark bg-bg-light dark:bg-bg-dark transition-colors duration-300 overflow-x-hidden">
      ...
      {/* =========================================================
          FLOATING WHATSAPP BUTTON (SATU NOMOR CS)
         ========================================================= */}
      <div className="fixed bottom-6 right-6 z-[100] flex flex-col items-end">

        {/* TOMBOL HIJAU UTAMA (Bulat) -- langsung buka WhatsApp */}
        <button
          type="button"
          aria-label="Hubungi kami via WhatsApp"
          className="relative group cursor-pointer"
          onClick={() => handleCSClick('6285187283900', 'Floating WA')}
        >
          {/* Efek Glow */}
