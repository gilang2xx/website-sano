...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="min-h-screen flex flex-col font-sans text-slate-800 dark:text-text-dark bg-bg-light dark:bg-bg-dark transition-colors duration-300 overflow-x-hidden">
        ...
        <div className="bg-white dark:bg-slate-900/95 backdrop-blur-sm rounded-full shadow-xl px-6 py-3 md:px-8 flex items-center gap-4 border border-slate-100 dark:border-slate-800">
          ...
          >
             <img
                ...
                className="h-6 md:h-12 w-auto object-contain block dark:hidden" 
              />
              ...
              <img
                ...
                alt="SANO Logo Dark"
                // Samakan ukurannya
                className="h-5 md:h-12 w-auto object-contain hidden dark:block"
              />
              </NavLink>
      ...
      >
        <span className="absolute -inset-2 rounded-full bg-green-500/50 opacity-75 animate-ping"></span>
        <div className="absolute inset-0 rounded-full bg-green-400 blur-lg opacity-40 group-hover:opacity-100 transition-opacity duration-300"></div>
        <div className="relative bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-2xl transition-all duration-300 transform group-hover:scale-110 group-hover:-translate-y-1 flex items-center justify-center border-2 border-white/20">
          <svg
